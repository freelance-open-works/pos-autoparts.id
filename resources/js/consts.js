...
export const purchase_order_status_selesai = 'selesai'

export const purchase_order_status = [
    purchase_order_status_draft,
    purchase_order_status_proses,
...
export const claim_status_draft = 'draft'
export const claim_status_proses = 'proses'
export const claim_status_submit = 'submit'
export const claim_status_selesai = 'selesai'
